...
def index(request):
    ...
    return render(request, "forum/list.html", {'categories': categories, 'user': request.user})
...
def forum(request, slug):
    ...
    return render(request, "forum/forum.html", add_csrf(request, topics=topics, forum=forum))
...
def topic(request, slug, topic_id):
    ...
    return render(request, "forum/topic.html", add_csrf(request, forum=forum, posts=posts, topic=topic))
